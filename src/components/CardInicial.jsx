...
export function CardInicial({handleMudarNotaAvalicao, handleSubmit}) {
    return (
        <div className="bg-gradient-dark text-white mx-6 p-6 rounded-2xl font-overpass max-w-103">
            ...
            <div className="flex justify-between mb-6">
               <InputButton handleMudarNotaAvalicao={handleMudarNotaAvalicao} value={1}/>
               <InputButton handleMudarNotaAvalicao={handleMudarNotaAvalicao} value={2}/>
               <InputButton handleMudarNotaAvalicao={handleMudarNotaAvalicao} value={3}/>
               <InputButton handleMudarNotaAvalicao={handleMudarNotaAvalicao} value={4}/>
               <InputButton handleMudarNotaAvalicao={handleMudarNotaAvalicao} value={5}/>
            </div>
